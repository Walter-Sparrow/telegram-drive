...
FILE_NOTIFY_INFORMATION *NextNotification(FILE_NOTIFY_INFORMATION *Notification)
{
...
{
    return std::wstring(Notification->FileName, Notification->FileNameLength / sizeof(wchar_t));
}
